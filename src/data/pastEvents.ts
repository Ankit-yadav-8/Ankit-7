...
export const pastEventsData: PastEvent[] = [
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      'The initiative witnessed an overwhelming response from the IIT Roorkee community, with nearly 400 students, faculty members, staff, and professors coming forward to participate in this noble cause. Senior institute officials graced the occasion, commending the participants for their selflessness and encouraging the dedicated volunteers who worked tirelessly to make the event a success. The spirit of service was truly commendable; despite the heavy rainfall and challenging weather conditions on the day of the event, the community’s determination remained unshaken. Students and staff queued up with great enthusiasm, reflecting the institute’s deep-rooted commitment to social welfare and the core values of Parakram Diwas. This collective effort not only celebrated the legacy of Netaji Subhas Chandra Bose but also demonstrated the power of unity and civic responsibility within the campus.',
      'To guarantee the highest standards of safety and hygiene, experienced medical teams were deployed, ensuring that the entire blood collection process remained systematic, comfortable, and efficient for all participants. As a token of heartfelt gratitude for their life-saving contributions, every donor was presented with special mementos and curated gift bags. The smooth execution of the camp was largely driven by the unwavering dedication of student volunteers, who played a crucial role in coordinating registrations, guiding donors through the medical checks, and maintaining a highly organised and welcoming environment. Ultimately, the Parakram Diwas Blood Donation Camp successfully transformed the enduring ideals of courage, compassion, and selfless service into meaningful, life-saving action, leaving a lasting impact on both the donors and the wider community.'
    ]
  }
];
